...
public class Matrix4f implements java.io.Serializable, Cloneable {
	...
	public Matrix4f(Vector3f t1, Quat4f q1, Vector3f s) {
		this(q1, t1, s);
	}

	public Matrix4f(Quat4f q1, Vector3f t1, Vector3f s) {
	...
	public Matrix4f(Matrix3f m1, Vector3f t1, Vector3f s) {
		this.m00 = m1.m00 * s.x;
		this.m01 = m1.m01 * s.y;
		this.m02 = m1.m02 * s.z;
		this.m03 = t1.x;
	...
	public final void setScale(Vector3f scale) {
		...
		m00 = (float) (tmp_rot[0] * scale.x);
		m01 = (float) (tmp_rot[1] * scale.y);
		m02 = (float) (tmp_rot[2] * scale.z);

		m10 = (float) (tmp_rot[3] * scale.x);
		m11 = (float) (tmp_rot[4] * scale.y);
		m12 = (float) (tmp_rot[5] * scale.z);

		m20 = (float) (tmp_rot[6] * scale.x);
		m21 = (float) (tmp_rot[7] * scale.y);
		m22 = (float) (tmp_rot[8] * scale.z);
	...
	public Quat4f getRotation(Quat4f get) {
		this.get(get);
		return get;
	}

	public Quat4f getRotation() {
		Quat4f get = new Quat4f();
		this.get(get);
		return get;
	}
	...
	public Vector3f getTranslation(Vector3f get) {
		this.get(get);
		return get;
	}

	public Vector3f getTranslation() {
		Vector3f get = new Vector3f();
		this.get(get);
		return get;
	}
	...
	public final void set(Quat4d q1, Vector3d t1, Vector3d s) {
		this.m00 = (float) (s.x * (1.0 - 2.0 * q1.y * q1.y - 2.0 * q1.z * q1.z));
		this.m10 = (float) (s.y * (2.0 * (q1.x * q1.y + q1.w * q1.z)));
		this.m20 = (float) (s.x * (2.0 * (q1.x * q1.z - q1.w * q1.y)));

		this.m01 = (float) (s.x * (2.0 * (q1.x * q1.y - q1.w * q1.z)));
		this.m11 = (float) (s.y * (1.0 - 2.0 * q1.x * q1.x - 2.0 * q1.z * q1.z));
		this.m21 = (float) (s.z * (2.0 * (q1.y * q1.z + q1.w * q1.x)));

		this.m02 = (float) (s.x * (2.0 * (q1.x * q1.z + q1.w * q1.y)));
		this.m12 = (float) (s.y * (2.0 * (q1.y * q1.z - q1.w * q1.x)));
		this.m22 = (float) (s.z * (1.0 - 2.0 * q1.x * q1.x - 2.0 * q1.y * q1.y));
	...
	public final void set(Quat4f q1, Vector3f t1, Vector3f s) {
		this.m00 = (float) (s.x * (1.0 - 2.0 * q1.y * q1.y - 2.0 * q1.z * q1.z));
		this.m10 = (float) (s.y * (2.0 * (q1.x * q1.y + q1.w * q1.z)));
		this.m20 = (float) (s.x * (2.0 * (q1.x * q1.z - q1.w * q1.y)));
	...
	public final void set(Matrix3d m1, Vector3d t1, Vector3d scale) {
		this.m00 = (float) (m1.m00 * scale.x);
		this.m01 = (float) (m1.m01 * scale.y);
		this.m02 = (float) (m1.m02 * scale.z);
		this.m03 = (float) t1.x;

		this.m10 = (float) (m1.m10 * scale.x);
		this.m11 = (float) (m1.m11 * scale.y);
		this.m12 = (float) (m1.m12 * scale.z);
		this.m13 = (float) t1.y;

		this.m20 = (float) (m1.m20 * scale.x);
		this.m21 = (float) (m1.m21 * scale.y);
		this.m22 = (float) (m1.m22 * scale.z);
		this.m23 = (float) t1.z;
	...
	public float getScaleXSquared() {
		return this.m00 * this.m00 + this.m01 * this.m01 + this.m02 * this.m02;
	}

	/** @return the squared scale factor on the Y axis */
	public float getScaleYSquared() {
		return this.m10 * this.m10 + this.m11 * this.m11 + this.m12 * this.m12;
	}

	/** @return the squared scale factor on the Z axis */
	public float getScaleZSquared() {
		return this.m20 * this.m20 + this.m21 * this.m21 + this.m22 * this.m22;
	}

	/** @return the scale factor on the X axis (non-negative) */
	public float getScaleX() {
		return (MathUtils.isZero(this.m01) && MathUtils.isZero(this.m02)) ? Math.abs(this.m00)
				: (float) Math.sqrt(getScaleXSquared());
	}

	/** @return the scale factor on the Y axis (non-negative) */
	public float getScaleY() {
		return (MathUtils.isZero(this.m10) && MathUtils.isZero(this.m12)) ? Math.abs(this.m11)
				: (float) Math.sqrt(getScaleYSquared());
	}

	/** @return the scale factor on the X axis (non-negative) */
	public float getScaleZ() {
		return (MathUtils.isZero(this.m20) && MathUtils.isZero(this.m21)) ? Math.abs(this.m22)
				: (float) Math.sqrt(getScaleZSquared());
	}

	public Vector3f getScale(Vector3f result) {
		float x = this.getScaleX();
		float y = this.getScaleY();
		float z = this.getScaleZ();
		result.set(x, y, z);
		return result;
	}
