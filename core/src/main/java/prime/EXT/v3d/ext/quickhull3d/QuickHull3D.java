 ...
 * software.
 */
package prime.EXT.v3d.ext.quickhull3d;
...
public class QuickHull3D {
	...
	//////
	public static Array<Point3d> transmute(Array<Vector3> pts)
	{
		Array<Point3d> result = new Array<Point3d>(true, pts.size, Point3d.class);
		for(int i = 0; i < pts.size; i++)
		{
			result.add(new Point3d(pts.get(i)));
		}
