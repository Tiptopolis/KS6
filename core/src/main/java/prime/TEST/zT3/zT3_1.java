...
public class zT3_1 extends uApp {
	...
	public void genMesh() {
		...
		N2 = new Node(T2);
		N3 = new Node(T3);
		Log(_VTS.Global.getA("Mesh") + " _<_");
		N4 = new Node<Mesh>("MeshNode", new Mesh(), _VTS.Global.getA("Mesh"));
		N4.set(T);
		Log(N4.Name() + " _____" + N4.Type());
		Log();
		Log(N4.toLog());
		Log("____________");
		Log(N4.megaLog());
